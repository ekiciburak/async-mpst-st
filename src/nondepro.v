...
Proof. intro b.
       ...
       - rewrite(st_eq(merge_bpf_cont (bpf_receive s s0 s1 b) (p ! [(l, s2, w)]))) in H1.
         ...
         + subst. 
           ...
           ++ rewrite eqb_eq in H2. subst.
              assert((ApnA3 a n) = apf_end) by admit.
              rewrite H2 in H6.
           ...
           ++ rewrite eqb_neq in H2.
              assert(isInA (ApnA3 a n) s = false) by admit.
              ...
              * assert(merge_bpf_cont b0 (p ! [(l, s', w')]) = merge_bpf_cont b0 (p ! [(l, s', w')])) by easy.
                ...
                assert((s3 & [(s4, s5, merge_bpf_cont (Bpf_merge (Ap2BpSeq a1) (bpf_receive s s0 s'0 b2)) w')]) =
                       merge_apf_cont (apf_receive s3 s4 s5 a1) (s & [(s0, s'0, merge_bpf_cont b2 w')])) by admit.
                rewrite H11.
                pfold.
                ...
                assert((merge_apf_cont (apf_receive s3 s4 s5 a1) (merge_bpf_cont b2 w')) =
                       (merge_bpf_cont (Bpf_merge (Ap2BpSeq (apf_receive s3 s4 s5 a1)) b2) w')) by admit.
                rewrite H12.
                apply IHb  with (p := p) (l := l) (s := s2) (s' := s').
                easy. admit.
                rewrite HQ2 in H9.
                ...
                assert((merge_apf_cont (apf_receive s3 s4 s5 a1) (merge_bpf_cont b2 (p ! [(l, s', w')]))) =
                       (merge_bpf_cont (Bpf_merge (Ap2BpSeq (apf_receive s3 s4 s5 a1)) b2) (p ! [(l, s', w')]))) by admit.
                rewrite H13 in H9.
                easy.
                admit.
              * specialize(mcBp2Ap b0 (p ! [(l, s', w')]) H4); intro HP.
                ...
                ** apply apf_eqb_neq in H5.
                   ...
                   assert(merge_apf_cont c (p ! [(l, s', w')]) = 
                          merge_bpf_cont (Ap2BpSeq c) (p ! [(l, s', w')])) by admit.
                   rewrite H13 in HQ2.
                   assert(isInB (Ap2BpSeq c) p = false) by admit.
                   specialize(pneqq6 (Ap2BpSeq c) p s s0 l s'0 s' w'0 w' H14 HQ2); intro HP.
                   destruct HP as (b2,(Hb2,(Hb3,Hb4))).
                   rewrite HP2.
                   rewrite HQ1.
                   assert((Ap2BpSeq (Apf_merge a1 c))  = (Bpf_merge (Ap2BpSeq a1) (Ap2BpSeq c))) by admit.
       ...
       - case_eq b2; intros.
         + subst. simpl in H. simpl in H0.
           ...
           destruct H as (Ha, Hb).
           rewrite eqb_neq in Ha.
           assert(isInB (BpnB3 b1 n) s = false) by admit.
           ...
           ++ assert(b0 = b2) by admit.
              subst.
              assert((p ! [(l, s', w')]) = (s ! [(s0, s'0, w'0)])) by admit.
           ...
           ++ assert(b0 <> b2) by admit.
              ...
              * destruct HQ as (c,(HQ1,(HQ2,(HQ3,HQ4)))).
                ...
                assert((s3 & [(s4, s5, merge_bpf_cont b0 w')]) = 
                       (merge_bpf_cont (Bpf_merge (Ap2BpSeq (apf_receive s3 s4 s5 apf_end)) b0) w') ) by admit.
                rewrite H11.
                rewrite HPb.
                assert((merge_bpf_cont (Bpf_merge (Ap2BpSeq (apf_receive s3 s4 s5 apf_end)) b0) (merge_bpf_cont b3 (s ! [(s0, s'0, w'0)]))) =
                       (merge_bpf_cont (Bpf_merge (Ap2BpSeq (apf_receive s3 s4 s5 apf_end)) (Bpf_merge b0 b3)) (s ! [(s0, s'0, w'0)]))) by admit.
                rewrite H12.
                pfold.
                ...
                assert((merge_bpf_cont (bpf_receive s3 s4 s5 (Bpf_merge b0 b3)) w'0) =
                       (merge_bpf_cont (bpf_receive s3 s4 s5 b0) (merge_bpf_cont b3 w'0))) by admit.
                rewrite H13.
                apply IHb  with (p := p) (l := l) (s := s2) (s' := s').
                easy. simpl. easy.
                rewrite HP3 in H9.
              ...
              * destruct HQ as (c,(HQ1,(HQ2,(HQ3,HQ4)))).
                ...
                assert((merge_bpf_cont (Bpf_merge (Ap2BpSeq (apf_receive s3 s4 s5 apf_end)) (Bpf_merge b2 (bpf_send s s0 s'0 b3))) w') =
                       (merge_bpf_cont (Bpf_merge (Ap2BpSeq (apf_receive s3 s4 s5 apf_end)) b2) (s ! [(s0, s'0, merge_bpf_cont b3 w')]))) by admit.
                rewrite H12.
                ...
                assert((merge_bpf_cont (bpf_receive s3 s4 s5 b2) (merge_bpf_cont b3 w')) =
                       (merge_bpf_cont (bpf_receive s3 s4 s5 (Bpf_merge b2 b3)) w')) by admit.
                rewrite H13.
                apply IHb  with (p := p) (l := l) (s := s2) (s' := s').
                easy.
                simpl. admit.
                ...
                assert((merge_bpf_cont (bpf_receive s3 s4 s5 b2) (merge_bpf_cont b3 (p ! [(l, s', w')]))) =
                       (merge_bpf_cont (bpf_receive s3 s4 s5 (Bpf_merge b2 b3)) (p ! [(l, s', w')])) ) by admit.
                rewrite H14 in H9.
                easy.
                admit.
                apply refinementR3_mon.
         + subst.
           ...
           ++ rewrite eqb_eq in H. subst.
              assert((BpnB3 b1 n) = bpf_end) by admit.
              rewrite H in H4.
              ...
              * assert (b0 <> b2) by admit.
                ...
                ** destruct HP as (c,(HPa,(HPb,(HPc,HPd)))).
                   ...
                   assert((s3 ! [(s4, s5, merge_bpf_cont b0 (merge_bpf_cont b3 (s ! [(s0, s'0, w'0)])))]) =
                          (merge_bpf_cont (bpf_send s3 s4 s5 (Bpf_merge b0 b3)) (s ! [(s0, s'0, w'0)]))) by admit.
                   rewrite H11.
                   pfold.
                   specialize(ref3_b (upaco2 refinementR3 bot2)
                   (merge_bpf_cont b w) w'0 s s0 s1 s'0
                   ...
                   assert((merge_bpf_cont (bpf_send s3 s4 s5 (Bpf_merge b0 b3)) w'0) =
                          (merge_bpf_cont (bpf_send s3 s4 s5 b0) (merge_bpf_cont b3 w'0))) by admit.
                   rewrite H12.
                   apply IHb  with (p := p) (l := l) (s := s2) (s' := s').
                   easy. simpl. admit.
                   rewrite HQ3 in H7.
                   ...
                   assert((merge_bpf_cont (bpf_send s3 s4 s5 (Bpf_merge b0 (bpf_send p l s' b3))) w'0) =
                          (merge_bpf_cont (bpf_send s3 s4 s5 b0) (p ! [(l, s', merge_bpf_cont b3 w'0)]))) by admit.
                ...
                ** destruct HP as (c,(HPa,(HPb,(HPc,HPd)))).
                   ...
                   assert((s3 ! [(s4, s5, merge_bpf_cont (Bpf_merge b2 (bpf_send s s0 s'0 b3)) w')]) =
                          (merge_bpf_cont (bpf_send s3 s4 s5 b2) (s ! [(s0, s'0, merge_bpf_cont b3 w')]))) by admit.
                   rewrite H10.
                   pfold.
                   specialize(ref3_b (upaco2 refinementR3 bot2)
                   (merge_bpf_cont b w) (merge_bpf_cont b3 w') s s0 s1 s'0
                   ...
                   assert((merge_bpf_cont (bpf_send s3 s4 s5 b2) (merge_bpf_cont b3 w')) =
                          (merge_bpf_cont (Bpf_merge (bpf_send s3 s4 s5 b2) b3) w')) by admit.
                   rewrite H11.
                   apply IHb  with (p := p) (l := l) (s := s2) (s' := s').
                   easy. simpl. admit.
                   rewrite HQ3 in H7.
      ...
      - rewrite bpfend_bn.
        ...
        + assert((BpnB3 b n) = b2) by admit.
          subst.
          assert((p ! [(l, s'0, w'0)]) = (p ! [(l, s', w')])) by admit.
          inversion H3. subst.
          easy.
        + assert((BpnB3 b n) <> b2) by admit.
          ...
          ++ destruct HP as (c,(HPa,(HPb,(HPc,HPd)))).
             ...
             assert((merge_bpf_cont (Bpf_merge b2 bpf_end) w'0) =
                    (merge_bpf_cont b2 w'0)) by admit.
             rewrite H12 in H9.
             easy.
          ++ destruct HP as (c,(HPa,(HPb,(HPc,HPd)))).
             assert(c = bpf_end) by admit.
             ...
             assert((merge_bpf_cont (Bpf_merge (BpnB3 b n) bpf_end) w') =
                    (merge_bpf_cont (BpnB3 b n) w')) by admit.
             rewrite H12.
             easy.
             apply refinementR3_mon.
Admitted.
...
(* Lemma dropR: forall a p l s s' w w',
  isInA a p = false ->
  subsort s' s ->
  paco2 refinementR3 bot2 (merge_apf_cont a (p & [(l, s, w)])) (p & [(l, s', w')]) ->
  paco2 refinementR3 bot2 (merge_apf_cont a w) w'.
Proof. intro a.
       induction a; intros.
       - rewrite apfend_an in H1.
         rewrite apfend_an.
         ...
         + subst.
           ...
           { symmetry in H6.
             specialize(noPre (ApnA3 a n) p l s' w' (p & [(l, s'0, w'0)]) H2 H6); intro HP.
             easy.
           }
           rewrite H3 in H6. rewrite apfend_an in H6.
           inversion H6. subst.
           rewrite H3 in H9. rewrite apfend_an in H9.
           easy.
           admit.
       - rewrite(st_eq (merge_apf_cont (apf_receive s s0 s1 a) (p & [(l, s2, w)]))) in H1. simpl in H1.
         ...
         rewrite(st_eq(merge_apf_cont (apf_receive s s0 s1 a) w)). simpl.
(*          pinversion H1. *)
         assert(paco2 refinementR3 bot2 (merge_apf_cont (apf_receive s s0 s1 a) (p & [(l, s2, w)])) (p & [(l, s', w')])).
         { rewrite(st_eq(merge_apf_cont (apf_receive s s0 s1 a) (p & [(l, s2, w)]))). simpl. easy. }
         pinversion H. subst.
         rewrite(st_eq(merge_apf_cont (apf_receive s s0 s1 a) (p & [(l, s2, w)]))) in H2.
         simpl in H2. inversion H2.
         subst.
         rewrite <- meqAp3 in H3, H6.
         specialize(InLA a (ApnA3 a0 n) p l s2 w w'0 Hb H6); intro HI.
         
         destruct HI as [HI | HI].
         + destruct HI as (a1,(a2,(s'',(Hc,(Hd,He))))).
           assert(a1 = apf_end).
           { rewrite He in H3.
             rewrite reOrg2 in H3.
             symmetry in H3.
             specialize(noPre a1 p l s' w'  (p & [(l, s'', merge_apf_cont a2 (s & [(s0, s'0, w'0)]))]) Hc H3); intro HP.
             easy.
           }
           rewrite H8 in He. simpl in He.
           rewrite He in H3.
           rewrite(st_eq(merge_apf_cont (apf_receive p l s'' a2) (s & [(s0, s'0, w'0)]))) in H3. simpl in H3.
           inversion H3. subst.
           pfold.
           specialize(ref3_a (upaco2 refinementR3 bot2) (merge_apf_cont a w) w'0
             s s0 s1 s'0 a2 1
           ...
           apply HR.
           easy.
           assert(isInA (ApnA3 a0 n) s = false) as HNN.
           { case_eq n; intros.
             - simpl. easy.
             - rewrite <- InN; easy.
           }
           rewrite He in HNN.
           simpl in HNN. rewrite orbtf in HNN. easy.
           rewrite He in H6.
           rewrite(st_eq(merge_apf_cont (apf_receive p l s' a2) w'0)) in H6. simpl in H6.
           left.
           specialize(IHa p l s2 s').
           apply IHa. easy. easy. easy.
           admit.
         + destruct HI as (a1,(w1,(s'',(Hc,(Hd,(He,Hf)))))).
           assert((ApnA3 a0 n) = apf_end).
           { symmetry in H3.
             specialize(noPre (ApnA3 a0 n) p l s' w' (s & [(s0, s'0, w'0)]) He H3); intro HP.
             easy.
           }
           rewrite H8 in H3.
           rewrite apfend_an in H3. inversion H3. subst. easy.
         rewrite(st_eq(merge_apf_cont (apf_receive s s0 s1 a) (p & [(l, s2, w)]))) in H2.
         simpl in H2. easy.
         admit.
Admitted. *)
       ...
       - subst. pinversion Hb.
         + subst. 
           ...
           + rewrite eqb_neq in H8.
             ...
             rewrite <- meqAp3.
             specialize(mcAp2Bp (ApnA3 a n0) (p0 & [(l0, s'0, w'0)])); intro HHa.
             destruct HHa as (b1, HHa).
             rewrite HHa.
             assert(b1 = Ap2BpSeq (ApnA3 a n0)) by admit.
             rename p0 into q.
(*              assert(merge_bpf_cont b1 (q & [(l0, s'0, w'0)]) = merge_bpf_cont (Bpf_merge b1 (bpf_receive q l0 s'0 bpf_end)) w'0).
             { admit. }
             rewrite H9. *)
             ...
             + rewrite eqb_neq in H9.
               assert(isInB (BpnB3 b n) p = false) by admit.
               specialize(pneqq5 (BpnB3 b n) p q l0 l s0 s' w0 w' H9 H10 H3); intros HR.
               ...
               (* use "InLBA" here *)
               rewrite He.
               assert((merge_bpf_cont b1 (q & [(l0, s'0, merge_bpf_cont b2 (p ! [(l, s'', w1)]))])) =
                      (merge_bpf_cont (Bpf_merge b1 (bpf_receive q l0 s'0 b2)) (p ! [(l, s'', w1)]))) by admit.
               rewrite H11.
               rewrite HR2 in H1.
               rewrite He in H6.
               assert((merge_apf_cont (ApnA3 a n0) (merge_bpf_cont b2 (p ! [(l, s'', w1)]))) =
                      (merge_bpf_cont (Ap2BpSeq (ApnA3 a n0)) (merge_bpf_cont b2 (p ! [(l, s'', w1)])))) by admit.
               rewrite H12 in H6.
               rewrite <- H8 in H6.
               pfold.
               specialize(ref3_b (upaco2 refinementR3 r) w w1 p l s s''
               (Bpf_merge b1 (bpf_receive q l0 s'0 b2)) 1
               ); intro HR3.
               simpl in HR3.
               apply HR3.
               admit.
               ...
               assert((merge_bpf_cont (Bpf_merge (Ap2BpSeq (ApnA3 a n0)) (bpf_receive q l0 s'0 b2)) w1) =
                      (merge_apf_cont (ApnA3 a n0) (merge_bpf_cont (bpf_receive q l0 s'0 b2) w1))) by admit.
               rewrite H13.
               rewrite H8 in H6.
               assert((merge_bpf_cont (Ap2BpSeq (ApnA3 a n0)) (merge_bpf_cont b2 (p ! [(l, s'', w1)]))) =
                      (merge_apf_cont (ApnA3 a n0) (merge_bpf_cont b2 (p ! [(l, s'', w1)])))) by admit.
               rewrite H14 in H6.
               unfold refinement3.
               ...
               left.
               assert( (merge_apf_cont (ApnA3 a n0) (merge_bpf_cont b2 (p ! [(l, s'', w1)]))) =
                       (merge_bpf_cont (Bpf_merge (Ap2BpSeq (ApnA3 a n0)) b2) (p ! [(l, s'', w1)]))) by admit.
               rewrite H15 in H6.
               apply dropBA in H6.
               assert((merge_bpf_cont (Bpf_merge (Ap2BpSeq (ApnA3 a n0)) b2) w1) = 
                      (merge_apf_cont (ApnA3 a n0) (merge_bpf_cont b2 w1))) by admit. 
                rewrite H16 in H6. easy.
                easy. admit. admit. admit.
             ...
             case_eq(eqb p0 p); intros.
             + rewrite eqb_eq in H8. subst.
               assert((BpnB3 b n) = bpf_end) by admit.
               rewrite H8 in H3.
             ...
             + rewrite eqb_neq in H8.
               ...
               ++ destruct HBB as (b2,(b3,(s2,(HBa,(HBb,HBc))))).
                  ...
                  assert((merge_bpf_cont b2 (merge_bpf_cont b3 (p0 ! [(l0, s'0, w'0)]))) =
                         (merge_bpf_cont (Bpf_merge b2 b3) (p0 ! [(l0, s'0, w'0)]))) by admit.
                  rewrite H12.
                  pfold.
                  specialize(ref3_b (upaco2 refinementR3 bot2) 
                  ...
                  assert((merge_bpf_cont b2 (merge_bpf_cont b3 w'0)) =
                         merge_bpf_cont (Bpf_merge b2 b3) w'0) by admit.
               ...
               ++ destruct HBB as (b2,(w2,(s2,(HBa,(HBb,(HBc,HBd)))))).
                  ...
                  by admit.
                  rewrite H14 in H6. easy. easy. admit.
                  admit.
                  admit.
             subst.
